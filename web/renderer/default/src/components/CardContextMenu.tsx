...
const itemCls =
  'cursor-pointer rounded px-2 py-1 text-sm outline-none hover:bg-slate-100 dark:hover:bg-slate-700 data-[disabled]:cursor-not-allowed data-[disabled]:text-slate-300 dark:data-[disabled]:text-slate-600'
      ...
      <ContextMenu.Portal>
        ...
        >
          ...
          <ContextMenu.Sub>
            ...
            >
              Move to column<span aria-hidden>▸</span>
            </ContextMenu.SubTrigger>
            <ContextMenu.Portal>
          ...
          <MoveToBoardSubmenu
            ...
            colIdx={colIdx}
            cardIdx={cardIdx}
            triggerCls={itemCls + ' flex items-center justify-between gap-2'}
